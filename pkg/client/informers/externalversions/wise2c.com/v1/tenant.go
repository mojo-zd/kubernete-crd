...
import (
	...
	versioned "gitee.com/wisecloud/crd/pkg/client/clientset/versioned"
	internalinterfaces "gitee.com/wisecloud/crd/pkg/client/informers/externalversions/internalinterfaces"
	v1 "gitee.com/wisecloud/crd/pkg/client/listers/wise2c.com/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.Wise2cV1().Tenants().List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Wise2cV1().Tenants().Watch(options)
			},
		},
		&wise2ccomv1.Tenant{},
		resyncPeriod,
...
func (f *tenantInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&wise2ccomv1.Tenant{}, f.defaultInformer)
}
